...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, EXT_LED_3_Pin|EXT_LED_2_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : LD2_Pin EXT_LED_3_Pin EXT_LED_2_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|EXT_LED_3_Pin|EXT_LED_2_Pin;
  ...
  /*Configure GPIO pin : EXT_LED_1_Pin */
  GPIO_InitStruct.Pin = EXT_LED_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(EXT_LED_1_GPIO_Port, &GPIO_InitStruct);
